...
class VoiceService:
    ...
    @classmethod
    def process_voice_command(cls, transcript: str, gemini_service, user_id: Optional[str] = None) -> Dict[str, Any]:
        from services.local_intelligence.execution_engine import ExecutionEngine
        result = ExecutionEngine.execute("voice", transcript, gemini_service, user_id)
        return {
